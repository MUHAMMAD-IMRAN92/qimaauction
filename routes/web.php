...
Route::get('/jury/link/give_cupping_review/{userId}/{table}/{sampleId?}/{productId?}', [App\Http\Controllers\OpenCuppingController::class, 'review2'])->name('give_cupping_review');
...
Route::get('/jury/link/give_review/{table?}/{juryId?}/{sampleId?}/{auctionId?}', [App\Http\Controllers\ProductController::class, 'review'])->name('give_review');
...
Route::get('/servertime', function () {
    return \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', '2023-08-08 11:00:00', 'BST').time();
    return \Carbon\Carbon::now()->format('Y-m-d H:i:s' , 'BST');
});
