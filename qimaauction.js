...
io.on('connection', function (socket) {
    ...
    socket.on('auto_bid_updates', function (data) {
        io.emit('auto_bid_updates', { "latestAutoBidId":data.latestAutoBidId,"bidID":data.bidID,"autobidamount":data.autobidamount,"id":data.id,"user_id":data.user_id,"paddleNo":data.paddleNo,"userbidAmount":data.userbidAmount,"totalAutoBidLiability":data.totalAutoBidLiability,"finaltotalliability":data.finaltotalliability });
     });
