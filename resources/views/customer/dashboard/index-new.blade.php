    ...
    <section >
        <div class="container-fluid" style="margin-top: -8px;">
            <div class="row" style="padding-top:40px;padding-bottom:40px">
                ...
                <b> <p class="text-center section-2-custom-text">
...
2300MASL</div></td>
    ...
    <td class="button"> <button>MORE INFORMATION</button></td>
  ...
  <tr >
    <td  class="rank"><div class="vl">#2</div></td>
    <td  class= style-td-1 ><div class="vl">AKRAM DARWAISH 7406</div></td>
    <td class="style-td-2" ><div class="vl" >90</div></td>
    <td  class="style-td-3" ><div class="vl">QABALALQAFR
IBB1800-2000MASL</div></td>
    <td class="style-td-4"><div class="vl" >74lbs</div></td>
    <td  class="style-td-5" ><div class="vl" >NATURAL</div></td>
    <td class="style-td-6">SL-34</td>
       <td class="button"> <button>MORE INFORMATION</button></td>

  </tr>
  <tr >
    <td  class="rank"><div class="vl">#3</div></td>
    <td  class= "style-td-1"><div class="vl">BAITALALXII
8595</div></td>
    <td  class="style-td-2
     ";><div class="vl " style="
    color: #232B38;
" >89.6</div></td>
    <td class="style-td-3"><div class="vl">BAITALALHAYMA KHARIJIYASANA
2300MASL</div></td>
    <td  class="style-td-4"><div class="vl">200lbs</div></td>
    <td style="
    COLOR: #E78460;
" class="style-td-5"><div class="vl" s>ALCHEMY</div></td>
  ...
  <tr >
    <td  class="rank"><div class="vl">#4</div></td>
    <td class="style-td-1" ><div class="vl">ALISUBAIH
7189</div></td>
    <td  class="style-td-2"
><div class="vl" style="
    color: #232B38;
">89.2</div></td>
    <td class="style-td-3"><div class="vl">BAITALALHAYMA KHARIJIYASANA
2300MASL</div></td>
    <td class="style-td-4"><div class="vl">163lbs</div></td>
    <td  class="style-td-5"><div class="vl" >SLOW DRIED</div></td>
    <td  class="style-td-6">YEMENIA
    </td>
    <td class="button"> <button>MORE INFORMATION</button></td>
  </tr>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-2  img-size">
                    ...
                    <div class="col-2 img-size"> <img src="././././public/images/2.png" alt="" width:60></div>
                ...
                <div class="col-2 img-size">
                    ...
                    <div class="col-2 img-size"> <img src="././././public/images/8.png" alt="" width:60></div>
                ...
                <div class="col-2 img-size">
                    ...
                    <div class="col-2 img-size"> <img src="././././public/images/15.png" alt="" width:60></div>
                ...
                <div class="col-2 img-size">
                    ...
                    <div class="col-2 img-size"> <img src="././././public/images/21.png" alt="" width:60></div>
                ...
                <div class="col-2 img-size">
                    ...
                    <div class="col-2 img-size"> <img src="././././public/images/27.png" alt="" width:60></div>
                ...
                <div class="col-lg-6 col-md-6 card-display">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body p-2">
                            ...
                            <p class="card-text-font">Qima Coffee and the Alliance for Coffee Excellence (ACE) have announced plans to host the
        ...
        <div class="container py-5">
            ...
            <div class="footerz">
                <div class="row text-center">
                    ...
                    <div class="col-12">
                        <a type="button" class="btn btn-outline-light" id="signup-for-newsletter" href="javascript:void(0)">SIGN UP FOR NEWSLETTER</a>
                    </div>
                </div>
            </div>
        </div>
