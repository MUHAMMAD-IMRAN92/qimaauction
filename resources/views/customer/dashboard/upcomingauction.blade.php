    ...
    <div class="container my-4">
        <nav>
            ...
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Auction</a>
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Liability</a>
            </div>
        </div>
        </nav>
                       ...
                       <tr class="hide-table-padding">
                        ...
                        <div id="collapseOne{{$auctionProduct->id}}" class="collapse in p-3">
                          <div class="row ">
                            ...
                            <div class="col-6">
                                <a class="btn btn-success ">AUTO BID</a><br>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr class="text-center">
                       ...
                       <td>6560 <a class="btn btn-success">Winning</a></td>                                       <td>Open:</td>
                      </tr>
                      <tr class="text-center">
                        <td>*1</td>
                        <td>90.1</td>
