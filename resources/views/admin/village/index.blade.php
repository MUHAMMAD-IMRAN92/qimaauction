        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="col-6 custom_btn_align">
                    <a href="{{ url('/village/create') }}" class="btn btn-primary waves-effect waves-light">Create
                        Village<a>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table zero-configuration" id="village-table">
                                                <thead>
                                                    <tr>
                                                        <th>Sr</th>
                                                        <th>Title</th>
...
<script>
    $(document).ready(function() {
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "mRender": function(data, type, row) {
                        var ids = btoa(row.id);
                        return `<td>` +
                            `<a class="" href="/village/edit/` + ids +
                            `">Edit</a>&nbsp&nbsp` +
                            // `<a class="" href="/village/delete/` + ids +
        ...
        t.on('draw.dt', function() {
            var BlogInfo = $('#village-table').DataTable().page.info();
            t.column(0, {
                page: 'current'
