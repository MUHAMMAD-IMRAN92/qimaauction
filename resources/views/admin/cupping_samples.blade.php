                                        ...
                                        <div class="table-responsive" id="no-more-tables">
                                            <div class="container w3-animate-opacity">
                                                <div class="tab">
                                                    ...
                                                    <button class="tablinks tablinks-custom-1 " id="1" onclick='javascript:sampleData(1,1)'>Table-1</button>
                                                    {{-- @endforeach --}}
                                                </div>
                                                                    ...
                                                                    <td data-title="Action">
                                                                        @if ($sample->is_hidden == 0)
                                                                            <a class="btn btn-success" target="_blank"
                                                                                href="{{ route('give_cupping_review', ['userId' => $userId,'table' => $sample->table, 'sampleId' => $sample->id]) }}">CUP
                                                                                SAMPLE
                                                                            </a>
                                                                        @else
                                                                            Completed
