                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ url('/governorate/edit') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-label-group">
                                                        ...
                                                        <input type="text" id="governorate-title" class="form-control" placeholder="Governorate Title" value="{{ $governorate->title }}" name="title">
