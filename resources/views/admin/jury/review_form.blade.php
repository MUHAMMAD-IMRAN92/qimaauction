                                                            ...
                                                            <div class="col-md-12 col-12">
                                                                <div class="form-label-group">
                                                                    ...
                                                                    <input type="text" id="name" class="form-control"
                                                                        name="cupping_score">
                                                                    <label for="name">Cupping Score</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-12">
                                                                <div class="form-label-group">
                                                                    ...
                                                                    <label for="email">Cupping Profile</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-12">
                                                                <div class="form-label-group">
                                                                    ...
                                                                    <label for="desc">Details About Sample</label>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-12 col-12">
                                                                <div class="form-label-group">
                                                                    <label for="sel">Cupping Method</label>
                                                                    <select name="" id="sel"></select>
                                                                    <option>Method one</option>
                                                                    <option>Method Two</option>
                                                                    <option>Method Three</option>
                                                                </div>
                                                            </div>
