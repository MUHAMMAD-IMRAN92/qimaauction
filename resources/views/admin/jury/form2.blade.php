                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <form action="{{ url('/jury/link/reviewSave') }}" method="POST" enctype="multipart/form-data" id="myForm">
                                                    ...
                                                    <p id="input_total_score" style="display: none"><input style="max-width:100%;text-align: center;font-size: 100px;font-family: 'EB Garamond';width: 448px;border: 1px solid gainsboro;border-radius: 6px;padding: 15px;" type="input" class="totalScore" name="total_score" id="total_score" value="84"></p>
