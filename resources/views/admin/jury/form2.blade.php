                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <form action="{{ url('/jury/link/reviewSave') }}" method="POST" enctype="multipart/form-data" id="myForm">
                                                    ...
                                                    <p id="input_total_score" style="max-width:100%;width: 267px;margin: auto;display: none"><input max="100" style="max-width:100%;text-align: center;font-size: 100px;font-family: 'EB Garamond';width: auto;border: 1px solid gainsboro;border-radius: 6px;padding: 15px;" type="input" class="totalScore" name="total_score" id="total_score" value="84"></p>
