                ...
                <div class="col-4 ">
                    ...
                    @if(request()->auction_id != '')
                        <div class="col-12 custom_btn_align mb-2">
                            <a href="{{route('auctionreport_csv',request()->auction_id)}}" class="btn btn-primary waves-effect waves-light" target="_blank" id="export" onclick="exportReport(event.target);">Export<a>
                        </div>
                    @endif
            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table zero-configuration" id="customer-table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>@if(request()->auction_id != ''){{$year}} @else @endif</td>
