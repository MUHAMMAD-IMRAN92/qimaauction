                                            ...
                                            <tbody>
                                                @forelse ($samples as $value=>$sample)
                                                    <tr>
                                                        ...
                                                        @if ($opencupping)
                                                            <td> <a
                                                                    href="{{ route('openCuppingReviewDetail', ['sample' => $sample->samples]) }}"><span
                                                                        class="product-link-a">View</span></a></td>
                                                        @else
                                                            <td> <a
                                                                    href="{{ route('review_detail', ['sample' => $sample->samples]) }}"><span
                                                                        class="product-link-a">View</span></a></td>
                                                        @endif
