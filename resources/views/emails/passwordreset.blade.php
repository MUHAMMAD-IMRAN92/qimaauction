...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
    ...
    <body>
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Login information</span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
...
<br>
You can reset your password by following <a href="{{ route('reset.password.get', $token) }}">this link.</a></p>
</div>
...
<p style="color: #222222;text-align: left;">Once you've signed in using your credentials, you can follow the link below to practice using the auction platform. Please note, when the auction goes live (18th August at 14:00 UK time), this link will take you to the real auction.&nbsp;</p>
</div>
